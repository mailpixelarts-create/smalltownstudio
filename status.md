...
**Date**: 2025-07-21
**Scope**: TypeScript fixes, preloader, page transitions, cursor cleanup, SplitType animations, branding updates, video lightbox
...
## Files Changed
- `js/main.ts` — 6 fixes (TS types, preloader interval, page transitions, cursor cleanup, double-click guard, SplitType fromTo)
